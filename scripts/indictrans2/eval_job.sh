...
# Usage: sbatch scripts/eval_job.sh <src> <tgt> <adapter_dir> <output_label>
# Example: sbatch scripts/eval_job.sh en mni ckpts/it2_en-mni_prim_avg/final prim_avg
...
python src/run_indictrans2_v3.py translate \
    --base "$BASE_MODEL" \
